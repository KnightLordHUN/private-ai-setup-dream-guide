...
# Private AI Setup Dream Guide - Open WebUI Only Setup for NVIDIA NIM
...
nvidia_nim_1_container_host_port=8005
...
# Start the Open WebUI Only Setup for NVIDIA NIM
echo "Starting the Open WebUI Only Setup for NVIDIA NIM..."
...
open_webui_container_args_base=(
    ...
    -e OPENAI_API_BASE_URLS="http://$open_webui_container_specific_target_host:$nvidia_nim_1_container_host_port/v1"
...
# End the Open WebUI Only Setup for NVIDIA NIM
echo "The Open WebUI Only Setup for NVIDIA NIM has Completed."
